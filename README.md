...
### Посещение веб сайта с конкретными условиями по подбору тарифа
 ...
 8. Перенаправление пользователя на сайт сотового оператора-эмитента тарифа. В случае ошибки -- вывести сообщение о недоступности тарифа в настоящее время и перейти к шагу 4 с сохранением ранее веденных фильтров, при этом удалить данный тариф из выдачи.
...
### Посещение сайта без конкретных условий по подбору тарифа
 ...
 6. Перенаправление пользователя на сайт сотового оператора-эмитента тарифа. В случае ошибки -- вывести сообщение о недоступности тарифа в настоящее время и перейти к шагу 4 с сохранением ранее веденных фильтров, при этом удалить данный тариф из выдачи.
